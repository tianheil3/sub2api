  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        test: '批量检测',
        schedule: '批量定时检测',
        scheduleTitle: '批量添加定时检测',
        scheduleDescription: '为选中的 {count} 个账号创建同一份定时检测计划。模型可留空，留空时使用各账号类型默认模型。',
        scheduleModelPlaceholder: '可选模型 ID，例如 gpt-5.5',
        scheduleCreate: '创建计划',
        scheduleCreateSuccess: '已为 {count} 个账号创建定时检测计划',
        scheduleCreatePartial: '定时检测计划部分创建成功：成功 {success} 个，失败 {failed} 个',
        scheduleCreateFailed: '创建计划失败',
        scheduleSummary: '完成：{success} 个已创建，{failed} 个失败',
        testTitle: '批量检测账号',
        testDescription: '将依次对选中的 {count} 个账号执行连接测试，结果会实时显示在下方。',
        testConcurrency: '并发数',
        testStart: '开始检测',
        testCancel: '取消检测',
        testProgress: '进度：{done}/{total}',
        testColAccount: '账号',
        testColPlatform: '平台',
        testColStatus: '检测结果',
        testColMessage: '详情',
        testStatusPending: '等待中',
        testStatusRunning: '检测中…',
        testStatusPass: '通过',
        testStatusFail: '失败',
        testStatusSkipped: '已跳过',
        testStatusUnauthorized: '401 未授权',
        testStatusRateLimited: '429 限流',
        testStatusTimeout: '超时',
        testSummary: '完成：{pass} 通过，{fail} 失败，{skipped} 跳过',
        testNoModel: '该账号无可用模型，已跳过'
      },
      bulkEdit: {
        title: '批量编辑账号',
    ...
    scheduledTests: {
      ...
      autoDisableOnUnauth: '401 自动暂停',
      autoDisableOnUnauthHelp: '当定时检测返回 401 未授权时，自动将该账号设为不可调度（暂停），需手动重新启用',
      autoDisableOnUnauthBadge: '401 自动暂停'
    },
    ...
    usage: {
      ...
      requestConversationTitle: '请求对话版本链',
      loadingConversation: '正在加载请求对话...',
      requestConversationEmpty: '该请求暂无可查看的对话快照。',
      requestConversationStageInbound: '客户端原始请求',
      requestConversationStageGatewayRewrite: '网关改写后',
      requestConversationStageUpstreamRetry: '上游重试版本',
      requestConversationStageUpstreamFinal: '最终上游请求',
      clickToViewBalance: '点击查看充值记录',
      failedToLoadUser: '加载用户信息失败',
      failedToLoadConversation: '加载请求对话失败',
      cleanup: {
        button: '清理',
        title: '清理使用记录',
