export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      oneClick: {
        title: 'Method 1: One-click setup script',
        recommended: 'Recommended',
        description: 'Recommended first. Copy and run it in your local terminal to write the selected client configuration.',
        unixPath: 'One-click setup script (macOS / Linux)',
        cmdPath: 'One-click setup script (Windows CMD)',
        powerShellPath: 'One-click setup script (PowerShell)',
      },
      orManual: 'or use manual configuration',
      manual: {
        title: 'Method 2: Manual configuration',
        description: 'If you cannot run the script, manually apply the files or environment variables below.',
      },
  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        scheduleTitle: 'Batch Add Scheduled Tests',
        scheduleDescription: 'Create the same scheduled test plan for {count} selected account(s). Leave model empty to use each account type default.',
        scheduleModelPlaceholder: 'Optional model ID, e.g. gpt-5.5',
        scheduleCreate: 'Create Plans',
        scheduleCreateSuccess: 'Created scheduled test plans for {count} account(s)',
        scheduleCreatePartial: 'Scheduled plans partially created: {success} succeeded, {failed} failed',
        scheduleCreateFailed: 'Failed to create plan',
        scheduleSummary: 'Done: {success} created, {failed} failed',
        testTitle: 'Batch Test Accounts',
        testDescription: 'Run a connection test against the {count} selected account(s). Results stream in below.',
        testConcurrency: 'Concurrency',
        testStart: 'Start Test',
        testCancel: 'Cancel',
        testProgress: 'Progress: {done}/{total}',
        testColAccount: 'Account',
        testColPlatform: 'Platform',
        testColStatus: 'Result',
        testColMessage: 'Details',
        testStatusPending: 'Pending',
        testStatusRunning: 'Testing…',
        testStatusPass: 'Pass',
        testStatusFail: 'Fail',
        testStatusSkipped: 'Skipped',
        testStatusUnauthorized: '401 Unauthorized',
        testStatusRateLimited: '429 Rate Limited',
        testStatusTimeout: 'Timeout',
        testSummary: 'Done: {pass} passed, {fail} failed, {skipped} skipped',
        testNoModel: 'No available model for this account, skipped'
      },
      bulkEdit: {
    ...
    usage: {
      ...
      requestConversationTitle: 'Request Conversation History',
      loadingConversation: 'Loading conversation history...',
      requestConversationEmpty: 'No conversation snapshots found for this request.',
      requestConversationStageInbound: 'Client Inbound',
      requestConversationStageGatewayRewrite: 'Gateway Rewritten',
      requestConversationStageUpstreamRetry: 'Upstream Retry',
      requestConversationStageUpstreamFinal: 'Final Upstream Payload',
      clickToViewBalance: 'Click to view balance history',
      failedToLoadUser: 'Failed to load user info',
      failedToLoadConversation: 'Failed to load conversation history',
      cleanup: {
        button: 'Cleanup',
